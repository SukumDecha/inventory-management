...
import { useGetExpenseByCategoryQuery } from "@/stores/api.slice";
import { IExpenseByCategorySummary } from "@/types";
...
const Expenses = () => {
  ...
  const aggregatedData: AggregatedDataItem[] = useMemo(() => {
    const filtered: AggregatedData = expenses
      ...
      .reduce((acc: AggregatedData, data: IExpenseByCategorySummary) => {
