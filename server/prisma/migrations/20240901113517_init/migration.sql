...
-- CreateTable
CREATE TABLE "ExepnseSummary" (
    "expenseSummaryId" TEXT NOT NULL,
    "totalExpense" DOUBLE PRECISION NOT NULL,
    "date" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "ExepnseSummary_pkey" PRIMARY KEY ("expenseSummaryId")
);
...
-- AddForeignKey
ALTER TABLE "ExpenseByCategory" ADD CONSTRAINT "ExpenseByCategory_expenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryId") REFERENCES "ExepnseSummary"("expenseSummaryId") ON DELETE RESTRICT ON UPDATE CASCADE;
